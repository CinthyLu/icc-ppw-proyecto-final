...
public class PdfReportServiceImpl implements PdfReportService {
    ...
    @Override
    public byte[] generateRegistrationCertificate(Long registrationId) {
        ...
        try {
            ...
            Paragraph emission = new Paragraph(
                    "Documento emitido el "
                            ...
                            + " en la zona horaria America/Guayaquil.",
                    smallFont()
            );
    ...
    private void addLogo(Document document)
        ...
        try (
            ...
            // El documento continúa generándose aunque el logo no pueda cargarse.
        }
    }
    ...
    private PdfPTable createRegistrationsTable(
        ...
        if (registrations.isEmpty()) {
            PdfPCell emptyCell = new PdfPCell(
                    new Phrase(
                            "No existen participantes inscritos en este evento.",
                            bodyFont()
                    )
            );

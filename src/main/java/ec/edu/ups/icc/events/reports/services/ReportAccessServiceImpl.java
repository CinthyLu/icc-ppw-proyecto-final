...
public class ReportAccessServiceImpl implements ReportAccessService {
    ...
    public ReportAccessServiceImpl(
    ...
    public void verifyEventReportAccess(Long eventId) {
        ...
        if (!isOrganizerOwner) {
            throw new ForbiddenException(
                    "No tienes permisos para descargar los inscritos de este evento"
            );
        }
    }

    @Override
    public void verifyCertificateAccess(Long registrationId) {
        ...
        if (!isParticipantOwner) {
            throw new ForbiddenException(
                    "No tienes permisos para descargar este comprobante de inscripción"
            );
        }
    }

...
public class AuditLogService {
    ...
    public AuditLogEntity record(
        ...
        auditLog.setAction(truncate(
                action,
                ACTION_MAX_LENGTH
        ));
        auditLog.setResourceName(truncate(
                resourceName,
                RESOURCE_NAME_MAX_LENGTH
        ));
        auditLog.setResourceId(truncate(
                resourceId,
        ...
        if (request != null) {
            auditLog.setIpAddress(truncate(
                    resolveIpAddress(request),
                    IP_ADDRESS_MAX_LENGTH
            ));

            auditLog.setUserAgent(truncate(
